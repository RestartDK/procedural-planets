 ...
 */
function createPlanetPreview(parameters) {
...
function createPlanetCard(planet) {
    ...
    card.innerHTML = `
        <div class="planet-preview">
            <img src="${preview}" alt="${planet.name}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
        </div>
        ...
        <div class="planet-actions">
            <a href="creator.html?id=${planet.id}" class="btn btn-primary">View</a>
...
function loadPlanets() {
    ...
    planets.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
